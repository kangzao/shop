package com.jep.shop.common.config;
...
public class SwaggerConfiguration {
    ...
    public Docket webApiDoc() {
        ...
        return new Docket(DocumentationType.OAS_30)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.jep.shop"))
                //正则匹配请求路径，并分配到当前项目组
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("1024电商平台")
                .description("微服务接口文档")
                .contact(new Contact("山海", "https://github.com/kangzao", "微信 _BigEye"))
                .version("v1.0")
                .build();
    }
